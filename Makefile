...
mpi_quad: main.o int3d.o measures_quadratic.o hpchain.o movchain.o mtwist.o abc_alg_parallel.o elf_tree_comm.o config.o abc_alg_common.o gyration.o fitness.o
	gcc $(CFLAGS) $(MPI_CFLAGS) $(UFLAGS) $(DEFS) $^ -o $@ $(LIBS) $(MPI_LIBS)
...
seq_lin: main.o int3d.o measures_linear.o hpchain.o movchain.o mtwist.o abc_alg_sequential.o config.o abc_alg_common.o gyration.o fitness.o
	gcc $(CFLAGS) $(UFLAGS) $(DEFS) $^ -o $@ $(LIBS)

seq_quad: main.o int3d.o measures_quadratic.o hpchain.o movchain.o mtwist.o abc_alg_sequential.o config.o abc_alg_common.o gyration.o fitness.o
	gcc $(CFLAGS) $(UFLAGS) $(DEFS) $^ -o $@ $(LIBS)
